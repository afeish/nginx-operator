...
import (
	...
	v1alpha1 "github.com/neocxf/nginx-operator/api/v1alpha1"
...
const (
	...
	generatedFromAnnotation = "nginx.neocxf.io/generated-from"
)
...
func LabelsForNginx(name string) map[string]string {
	return map[string]string{
		"nginx.neocxf.io/resource-name": name,
		"nginx.neocxf.io/app":           "nginx",
	}
}
...
func GetNginxNameFromObject(o client.Object) string {
	return o.GetLabels()["nginx.neocxf.io/resource-name"]
}
...
func setupConfig(conf *v1alpha1.ConfigRef, dep *appv1.Deployment) {
	...
	case v1alpha1.ConfigKindInline:
		...
		key := "nginx.neocxf.io/custom-nginx-config"
